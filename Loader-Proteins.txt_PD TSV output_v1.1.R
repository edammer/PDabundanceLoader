...
#########################################################################################################
## v1.1        -- Now supports "Master" PD output column with "Master Protein" as annotation (PD v2.5) ##
##                                                                                                     ##
#########################################################################################################
...
########### Configuration ########################
rootdir="c:/Users/Eric Dammer/Downloads/"
...
fileToLoad="./CuATSM_U+R_Anova_SN3_pvalue_tsv.txt"
...
outputFilename="1b.PD.TMT_normAbundances.NoCorrection.csv"
...
for (i in plexes) {
  ...
  if (minConfidence=="high") keepRowIndices=which(proteinGroups[[i]]$Confidence.Master=="High.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="High.Master Protein")
  if (minConfidence=="medium") keepRowIndices=which(proteinGroups[[i]]$Confidence.Master=="High.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="High.Master Protein" | proteinGroups[[i]]$Confidence.Master=="Medium.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="Medium.Master Protein")
  if (minConfidence=="low") keepRowIndices=which(proteinGroups[[i]]$Confidence.Master=="High.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="High.Master Protein" | proteinGroups[[i]]$Confidence.Master=="Medium.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="Medium.Master Protein" | proteinGroups[[i]]$Confidence.Master=="Low.IsMasterProtein" | proteinGroups[[i]]$Confidence.Master=="Low.Master Protein")
